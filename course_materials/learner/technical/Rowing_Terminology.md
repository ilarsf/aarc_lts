...
* **Handle:** The part of the oar the rower holds.
...
* **Finish (or Release):** The end of the drive phase when the blade is removed from the water.
* **Recovery:** The phase of the stroke when the rower moves back towards the stern to prepare for the next catch.
...
* **Back (or Back it Down):** Command to row in reverse.
* **Hold Water:** Command to stop the boat quickly by squaring the blades in the water.
