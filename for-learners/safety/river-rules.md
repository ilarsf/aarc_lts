...
<div class="container my-5">
    ...
    <div class="alert alert-warning" role="alert">
        ...
        <p>Want a clearer way to rehearse these rules? The <strong>AARC River Navigation Guide</strong> uses the real route map to walk through the coached course lines, bridge decisions, and common caution areas.</p>
        <p class="mb-0">
