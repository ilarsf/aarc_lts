...
<div class="tab-container drill-categories-tabs">
  <div class="tab-nav">
    ...
    <button class="tab-button" data-tab="technical-focus-drills">Technical Focus Drills</button>
    <button class="tab-button" data-tab="recovery-phase-drills">Recovery Phase Drills</button>
    <button class="tab-button" data-tab="drive-phase-drills">Drive Phase Drills</button>
    <button class="tab-button" data-tab="blade-control-drills">Blade Control Drills</button>
    <button class="tab-button" data-tab="boat-control-drills">Boat Control Drills</button>
    <button class="tab-button" data-tab="session-specific-drills">Session-Specific</button>
  ...
  <div class="tab-content" id="recovery-phase-drills">
    <div class="tab-content-inner">
...
/* Additional styles for drill tabs */
.drill-categories-tabs .tab-button {
  white-space: nowrap;
}
...
/* Ensure nested toggles work within tabs */
.nested-section {
  margin: 1rem 0;
