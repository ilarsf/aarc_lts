...
<div class="accordion-section">
  <button class="accordion-toggle">Key Drills Repertoire</button>
...
<div class="accordion-section">
  <button class="accordion-toggle">Technical Correction Guide</button>
  <div class="accordion-content">
    <div class="accordion-content-inner">
...
<div class="accordion-section">
  <button class="accordion-toggle">Teaching Frameworks</button>
  <div class="accordion-content">
    <div class="accordion-content-inner">
...
<div class="accordion-section">
  <button class="accordion-toggle">Video Analysis Guide</button>
  <div class="accordion-content">
    <div class="accordion-content-inner">
...
<div class="accordion-section">
  <button class="accordion-toggle">Equipment Adjustment Reference</button>
  <div class="accordion-content">
    <div class="accordion-content-inner">
...
<div class="accordion-section">
  <button class="accordion-toggle">Coaching Language Guide</button>
  <div class="accordion-content">
    <div class="accordion-content-inner">
