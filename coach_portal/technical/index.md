...
<div class="two-col-grid">
  ...
  <div class="resource-card">
    <h3>Equipment Adjustment Reference</h3>
...
<div class="info-box note mt-4">
  <h3>Recommended Coach Training</h3>
  <p>All AARC Learn to Scull coaches are encouraged to complete the following resources:</p>
  <ul class="mb-0">
    <li>USRowing Level 1 Coach Certification</li>
    <li>AARC Coach Training Workshop (held annually in April)</li>
    <li>CPR/First Aid Certification</li>
    <li>Safe Sport Training</li>
  </ul>
</div>
