...
⚠️ **Warning:** Never underestimate the weather. If in doubt, stay ashore. Your coach has the final authority to cancel practice due to unsafe conditions. *See the website's [LTS Weather Guidelines]({{ site.baseurl }}/for-learners/safety/weather-guidelines-lts.html) for more information.*
...
Following these rules prevents collisions and ensures predictable movement for all water users. *Consult the [River Rules Guide]({{ site.baseurl }}/for-learners/safety/river-rules.html) for a detailed explanation.*
...
💡 **Tip:** Everyone feels awkward during their first flip test! Relax, listen to your coach, and focus on the steps.
...
* Refer to videos linked in Appendix C or the [Video Library]({{ site.baseurl }}/for-learners/technique/videos.html).
* *For a comprehensive walkthrough, see the detailed [Sculling Self-Rescue Guide]({{ site.baseurl }}/resources/Sculling_Self_Rescue_Guide.html) available on the website.*

---

Mastering capsize recovery builds immense confidence. Remember the steps, stay calm, and trust the process. Part 4 shifts focus to resources for coaches.
