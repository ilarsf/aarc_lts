...
| Erg Session                       | 25 min        | Correct grip, basic stroke sequence intro (Pick/Reverse Pick)                             | Correct Grip, Sequencing  | "Fingers as hooks," "Legs-Body-Arms,"       | Proper erg setup, avoid hitting stops.                 |
| Equipment Overview (Slings)       | 20 min        | Boat parts (hull, riggers, seat, stretcher), oar parts                                    | N/A                       | "This is the rigger," "Adjust stretchers."  | Safe adjustment techniques.                            |
...
| Wrap-up, Q&A, Maintenance Intro   | 15 min        | Review key points, Q&A, boat cleaning/storage intro                                       | N/A                       | "Use spray bottles; wipes are at back near oars." | Report equipment issues promptly.                      |
...
| Equipment Prep                    | 20 min        | Oars down first, coach-managed boat assignment, safe carry to dock                | N/A                       | "Remember oars first," "Check your assigned boat." | Safe carrying, clear pathways.                    |
| Launching Procedure & Exec        | 20 min        | Review dock commands, safe launch steps, individual launching                    | N/A                       | "Bow points downstream," "Listen for 'Hands on'."   | Maintain dock order, assist, coach supervision. |
...
| Landing Procedure & Practice      | 15 min        | Review dock approach (downstream), safe landing, practice                          | N/A                       | "Approach dock slowly, downstream,"                 | Communicate intentions, clear dock quickly.       |
...
| On-Water Session 2                     | 40 min        | Continuous rowing focusing on leg drive, practice pivot turns                    | Application of pressure | "Maintain leg pressure," "Back one, gentle pull other."      | Check surroundings before turning, away from traffic.  |
...
| Equipment Prep & Launching             | 20 min        | Standard coach-managed assignment and launch procedure                                                   | N/A                | "Double check steering points."                               | Confirm each rower uses the assigned boat.                                  |
...
| Landing & Post-Rowing Maintenance      | 15 min        | Standard landing, cleaning, storage.                                                                      | N/A                | "Use spray bottles; wipes are at back near oars," "Report issues." | Efficient dock clearing.                                                 |
...
6.  **Post-Rowing:** Cleans/stores equipment, knows how to report equipment issues and understands independent-rowing equipment request and whiteboard procedures.
