...
*Refer back to the links provided in the [Video Library]({{ site.baseurl }}/for-learners/technique/videos.html) or other online resources provided by AARC to review these videos.*
...
*[For the most up-to-date FAQs and video links, please visit the [Learner FAQ]({{ site.baseurl }}/for-learners/resources/faq.html) and [Video Library]({{ site.baseurl }}/for-learners/technique/videos.html).]*
